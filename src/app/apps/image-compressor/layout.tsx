...
export const metadata: Metadata = {
  ...
  description:
    "Compress JPEG, PNG, WebP, and AVIF images with intelligent algorithms. Batch processing, no quality loss, 100% free and private — runs entirely in your browser.",
